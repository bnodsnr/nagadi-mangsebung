...
*/
  ...
  public function GetProfileList() 
  {
      if($this->input->is_ajax_request()) {
          ...
          $totalData              = $this->ProfileModel->CountProfile($org_file_no,$org_name,$reg_no,$contact_no);
          $totalFiltered          = $totalData;
          $posts                  = $this->ProfileModel->Getprofile($limit,$start,$order,$dir, $org_file_no,$org_name,$reg_no,$contact_no);
          $data           = array();
          if(!empty($posts))
          {
              $i = 1;
              foreach ($posts as $post)
              {
                  ...
                  $nestedData['father_name']      = $post->land_owner_father_name;
                  ...
                  if($check_if_bill_exits == TRUE) {
                    ...
                    $nestedData['v_billno'] = $check_if_bill_exits;
                  } else {
