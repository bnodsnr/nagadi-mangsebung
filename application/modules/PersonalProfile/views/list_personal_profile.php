        ...
        "columns": [
              ...
              { "data": "contact_no" },
              {
                "data":"", render:function( data, type, row ){
                  if(row.is_paid == "Paid") {
                  var res = '<a href="<?php echo base_url()?>SampatiKarRasid/viewRasid/'+row.v_billno+'"" class= "btn btn-shadow btn-success btn-sm" target="_blank"><i class="fa fa-check-circle"></i> भुक्तान गरिएको छ</a>';
                  } else {
