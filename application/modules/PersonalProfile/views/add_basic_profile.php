              ...
              <section class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        <label>स्थायी लेख</label>
                        <div class="input-group">
                          <input type="text" class="form-control" placeholder=""  name="lo_pan_no"  id="lo_czn_no" value="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="land_owner_gender" class="form-control dd_select" required>
                          ...
                          <option value="पुरुष महिला समेत">पुरुष महिला समेत</option>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control contact_number" placeholder=""  name="land_owner_contact_no"  value="">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control per_house_no" placeholder=""  name="lo_house_no"  value="">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control tem_house_no" placeholder=""  name="lo_temp_house_no"  value="">
                      </div>
                    </div>
