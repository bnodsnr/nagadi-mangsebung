          ...
          <div class="row">
            <div class="col-md-12">
              <section class="card">
                ...
                <input type="hidden" name="id" value="<?php echo !empty($profile_details['id']) ? $profile_details['id'] :'';?>">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        <label>नगरिकता नं <span style="color:red">*</span></label>
                          <input type="text" class="form-control citizenship_no" placeholder=""  name="lo_czn_no" required="required" value="<?php echo !empty($profile_details['lo_czn_no']) ? $profile_details['lo_czn_no']:'';?>">
                      ...
                      <div class="form-group">
                        ...
                        <select name="land_owner_gender" class="form-control dd_select" required>
                          ...
                          <option value="महिला" <?php if($profile_details['land_owner_gender'] == 'महिला'){ echo 'selected';}?>>महिला</option>
                           ...
                           <option value="पुरुष महिला समेत" <?php if($profile_details['land_owner_gender'] == 'पुरुष महिला समेत'){ echo 'selected';}?>>पुरुष महिला समेत</option>
            ...
            <div class="col-md-12">
              <section class="card">
                <header class="card-header" style="background: #1b5693;color:#FFF">जग्गा रहेको ठेगाना</header>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                   ...
                   <!--  <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control per_house_no" placeholder=""  name="lo_house_no" value="<?php echo !empty($profile_details['lo_house_no']) ? $profile_details['lo_house_no']: '' ?>">
                      </div>
                    </div>
            ...
            <div class="col-md-12">
              <section class="card">
                <header class="card-header" style="background: #1b5693;color:#FFF">जग्गाधनिको ठेगाना </header>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
    ...
    $('.btnAddNew').click(function(e) {
      ...
      var new_row = 
          '<tr class ="partsPurchaseFields" id="partsPurchaseFields_'+trOneNew+'" data-id="'+trOneNew+'">'+
            '<td>'+
              '<input type="text" name="family_member_name_new[]" value="" class="form-control">'+
            '</td>'+
          
            '<td><select class="form-control dd_select" name="family_member_relation_new[]" data-placeholder="छान्नुहोस्" id="main_topic'+trOneNew+'" data-id="'+trOneNew+'"><option value="">छान्नुहोस्</option><?php if(!empty($rel)) {
                          foreach ($rel as $key => $re) { ?><option value="<?php echo $re['name']?>"><?php echo $re['name']; } }?></option></select></td>'+
            '<td>'+
            '<input type="text" class="form-control nepaliDate5" id="#date_'+trOneNew+'" placeholder="YY-MM-DD" name="family_member_dob_new[]" required="required"data-mask="9999/99/99" tabindex="-1" autocomplete="off">'+
            '</td>'+
  ...
  $(document).ready(function(){
    ...
    $('.btnAddNew').click(function(e) {
      ...
      var new_row = 
          ...
          '</td>'+
          '<td>'+
          '<input type="text" class="form-control nepaliDate5" id="#date_'+trOneNew+'" placeholder="" name="family_member_dob[]" required="required" value="" tabindex="-1" autocomplete="off">'+
          '</td>'+
          '<td><select class="form-control dd_select" name="family_member_relation[]" data-placeholder="छान्नुहोस्" id="main_topic'+trOneNew+'" data-id="'+trOneNew+'"><option value="">छान्नुहोस्</option><?php if(!empty($rel)) {
                          foreach ($rel as $key => $re) { ?><option value="<?php echo $re['name']?>"><?php echo $re['name']; } }?></option></select></td>'+
          '<td><button type="button" class="btn btn-danger btn-sm remove-row" data-toggle="tooltip" title="हटाउनुहोस्"><span class="fa fa-times" tabindex="-1"></span></button></td>'+
        '<tr>'
      $("#add_new_fields").append(new_row);
    ...
    $(document).on('change', '.npl_state', function() {
      ...
      var ward = $('.address_ward').val();
      $.ajax({
        url:base_url+'Profile/getDistrictByState',
        method:"POST",
        data:{state:state, name:name,gapana:ward},
        success : function(resp){
          if(resp.status == 'success') {
            $('.npl_districts').html(resp.option);
          }
    ...
    $(document).on('change','#address_ward', function() {
      ...
      //alert(ganapa);
      $.ajax({
        url:base_url+'Profile/generateCode',
        method:"POST",
        data:{address_ward:address_ward,name:name,ganapa:ganapa},
        success : function(resp){
          $("#lo_owner_symbol").val(resp);
        }
      });
    ...
    $(document).on('change', '.npl_districts', function() {
      ...
      var district = obj.val();
      $.ajax({
        url:base_url+'Profile/getGapanapaByDistricts',
        method:"POST",
    ...
    $(document).on('input blur','.citizenship_no', function(){
      ...
      var citizenship_no = obj.val();
      $.ajax({
        url: base_url + 'Profile/getUniqueCitizenNo',
        method:"POST",
    ...
    $(document).on('input blur','.contact_number', function(){
      obj = $(this);
      var mobile = obj.val();
      $.ajax({
