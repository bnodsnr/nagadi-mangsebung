          ...
          <section class="wrapper">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">जग्गाको न्युनतम मुल्य</a></li>
              </ol>
            </nav>
              <!-- page start-->
              <div class="row">
                  ...
                  <section class="card" style="margin-bottom: -25px;">
                    <header class="card-header">
                      जग्गाको न्युनतम मुल्य
                        <span class="tools">
                        <a class="btn btn-info btn-success pull-right" href="<?php echo base_url()?>Setting/addJaagakoMinRate" style="color:#FFF"> नयाँ थप्नुहोस् </a>
                      </span>
                    </header>
                    <div class="card-body">
                      <div class="adv-table">
