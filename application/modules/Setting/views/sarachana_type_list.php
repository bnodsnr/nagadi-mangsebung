          ...
          <section class="wrapper">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">रोड को किसिम</a></li>
              </ol>
            </nav>
              <!-- page start-->
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <section class="card" style="margin-bottom: -25px;">
                    <header class="card-header">
                      संरचनाको प्रकार
                        <span class="tools">
                        <a class="btn btn-info btn-success pull-right" href="<?php echo base_url()?>Setting/addSadakKoKisim" style="color:#FFF"> नयाँ थप्नुहोस् </a>
                      </span>
                    </header>
                    <div class="card-body">
                      <div class="adv-table">
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                          <thead style="background: #1b5693; color:#fff">
                              <tr>
                                ...
                                <th>sanrachan_list</th>
                                <th class="hidden-phone">.....</th>
                              </tr>
                          </thead>
                          <tbody>
                            <?php if(!empty($sanrachan_list)) :
                              $i = 1;
                              foreach($sanrachan_list as $key => $value) : ?>
                              <tr class="gradeX">
