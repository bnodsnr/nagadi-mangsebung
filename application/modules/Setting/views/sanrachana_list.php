          ...
          <section class="wrapper">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">संरचनाको न्युनतम मूल्य</a></li>
              </ol>
            </nav>
              <!-- page start-->
              <div class="row">
                  ...
                  <section class="card">
                    <header class="card-header">
                     संरचनाको न्युनतम मूल्य
                        <span class="tools">
                        <a class="btn btn-info btn-success pull-right" href="<?php echo base_url()?>Setting/addSanrachanaRate" style="color:#FFF"> नयाँ थप्नुहोस् </a>
                      </span>
                    </header>
                    <div class="card-body">
                      <div class="adv-table">
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                          ...
                          <tbody>
                            <?php if(!empty($settings_structure_minimum_amount)) :
                              $i = 1;
                              foreach($settings_structure_minimum_amount as $key => $value) : ?>
                              <tr class="gradeX">
                                  ...
                                  <td><?php echo $this->mylibrary->convertedcit($value['minimum_amount'])?></td>
                                  <td class="center hidden-phone">
                                    <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>Setting/addSanrachanaRate/<?php echo $value['id']?>"><i class="fa fa-edit"></i></a>
