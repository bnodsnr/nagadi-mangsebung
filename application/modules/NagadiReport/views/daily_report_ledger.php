<form action="<?php echo base_url()?>OverAllReport/DailyIncomeLedger" method="post" class="form save_post">
				...
				<div class="row">
					<div class="col-sm-12">
						<table class="display table table-bordered" id="hidden-table-info">
							...
							<tbody>
								<?php $total = 0;if(!empty($main_topic)) : 
									$i=1; foreach($main_topic as $mt):
									$total_byMt = $this->Reportmodel->getNagadiTotalByMTD($mt['id']);
									?>
								...
								<tfoot>
									<tr>
										<td colspan="2"></td>
										<td>जम्मा रु:</td>
										<td><?php echo $this->mylibrary->convertedcit(number_format($total))?></td>
									</tr>
									<tr>
										<td colspan="5">अक्षरुपी : <?php echo $this->convertlib->convert_number($total,"मात्र |")."मात्र |";?></td>
									</tr>
								</tfoot>
							</table>
						</section>
