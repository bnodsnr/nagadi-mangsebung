        ...
        "columns": [
              ...
              { "data": "contact_no" },
              {
                "data":"", render:function( data, type, row ){
                  if(row.is_paid == "Paid") {
                  var res = '<a href="<?php echo base_url()?>SampatiKarRasid/printPreview/'+row.file_no_en+'"" class= "btn btn-shadow btn-success btn-sm" target="_blank"><i class="fa fa-check-circle"></i> भुक्तान गरिएको छ</a>';
                  } else {
                    var res = '<a href="<?php echo base_url()?>SampatiKarRasid/CreateBills/'+row.file_no_en+'" class= "btn btn-shadow btn-danger btn-sm" target="_blank"><i class="fa fa-times-circle"></i>  रसिद कट्नुहोसैन</a>';
                  }
                  return res;
