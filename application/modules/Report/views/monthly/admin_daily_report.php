 <a href="<?php echo base_url()?>Report/MonthlyReport/viewMonthlyCollectionDetails/<?php echo $current_month?>/<?php echo $ward_no?>" class="btn btn-warning btn-sm pull-right" target="_blank"><i class="fa fa-eye"></i> पुरा विवरण हेर्नुहोस</a>
      ...
      <?php if(!empty($main_topic)) : 
        ...
        foreach($main_topic as $mt):
          ...
          <tr>
            ...
            $collection_rate = $this->MonthlyReportmodel->MonthlyNagadiCollection($mt['id'], $current_month, $ward_no);
            ...
            <td><a href="<?php echo base_url()?>Report/MonthlyReport/viewByTopic/<?php echo $mt['id'].'/'.$current_month.'/'.$ward_no?>" class="btn btn-warning" target="_blank">विवरण हेर्नुहोस</a></td>
