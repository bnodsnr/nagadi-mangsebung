            ...
            <div class="tab-content tasi-tab" id="myTabContent">
                ...
                <div class="row">
                  ...
                  <div class = "search_monthly_report">
                    ...
                    <a href="<?php echo base_url()?>Report/MonthlyReport/viewMonthlyCollectionDetails" class="btn btn-warning btn-sm pull-right" style=""> <i class="fa fa-eye"></i> विवरण हेर्नुहोस</a>

                    <a href="<?php echo base_url()?>Report/MonthlyReport/printMonthlyCollection/<?php echo $current_month?>/<?php echo $session_ward?>" class="btn btn-info btn-sm pull-right" style="margin-right: 4px;"><i class="fa fa-print"></i> प्रिन्ट गर्नुहोस</a>
                      ...
                      <?php if(!empty($main_topic)) : 
                        ...
                        foreach($main_topic as $mt):
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo base_url()?>Report/MonthlyReport/viewByTopic/<?php echo $mt['id'].'/'.$current_month.'/'.$session_ward?>" class="btn btn-warning">विवरण हेर्नुहोस</a></td>
                        ...
                        <td><a href="<?php echo base_url()?>Report/MonthlyReport/viewSampatiKarDetails/<?php echo $mt['id'].'/'.$current_month.'/'.$session_ward?>" class="btn btn-warning">विवरण हेर्नुहोस</a></td>
