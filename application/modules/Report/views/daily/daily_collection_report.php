       ...
       <section class="card">
          ...
          <div class="card-body">
              ...
              <div class="tab-content tasi-tab" id="myTabContent">
                    ...
                    <div class="alert alert-info"><h2 class="text-center"><?php if($ward_no == '0'){ echo 'नगरपालिका' ;}  else { echo $this->mylibrary->convertedcit($ward_no).' नं वडा कार्यलय'; }?>   दैनिक  नगदी कर सङ्कलन रिपोर्ट
