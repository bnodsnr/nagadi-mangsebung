                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-2">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" placeholder="" name="bill_no" required="required"  value="<?php echo $bill?>" tabindex="-1" readonly>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="qty_title">परिमाण/रकम  </label>
                                       <input type="text" class="form-control topic_qty number_field" placeholder="" name="qty[]"  value="" style="height: 30px;" autocomplete="off" required="required">
                    ...
                    '<div class="row other_space_section">'+
                     ...
                     '</div>'+
                      ...
                      '<div class="col-md-4">'+
                        '<div class="form-group">'+
                          '<label class="qty_title">परिमाण/रकम</label>'+
                          '<input type="text" class="form-control topic_qty" placeholder="" name="qty[]" value="" style="height: 30px;" autocomplete="off" tabindex="-1" required="required">'+
                          '<span class="notifiy_percent" style="color:red"></span>'+
                        '</div>'+
                      '</div>'+
