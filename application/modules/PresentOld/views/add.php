    ...
    <div class="form-group">
      <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control " placeholder="" name="present_name" required="required" value="<?php if(!empty($row['id'])){ echo $row['present_name'];} else{echo GNAME;} ?>" readonly>
        </div>
