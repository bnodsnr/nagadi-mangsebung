             ...
             <!--   -->
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="pradesh" class="form-control" value="<?php echo PROVIENCE ?>" readonly>
                  <input type="hidden" name="provience_id" value="<?php echo PROVIENCEID?>">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="hidden" name="district_id" value="<?php echo DISTRICTID?>">
                </div>
              </div>
