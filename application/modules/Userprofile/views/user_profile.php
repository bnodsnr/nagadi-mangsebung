                      ...
                      <section class="card">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                            <?php if($this->session->userdata('PRJ_USER_ID') == 1) { ?>
                              <li class="nav-item"><a class="nav-link" href=""> <i class="fa fa-cog"></i> भर्खरका गतिविधिहरू</a></li>
                              <li class="nav-item"><a class="nav-link" href=""> <i class="fa fa-cog"></i> विवरण सम्पादन गर्नुहोस्</a></li>
                              <li class="nav-item"><a class="nav-link" href=""> <i class="fa fa-cog"></i> निस्क्रिय गर्नुहोस्</a></li>
                            <?php } ?>
