              ...
              <div class="btn-group hidden-phone">
                ...
                <div class="">
                  ...
                  <button type="button" class="btn btn-warning" title="खोजी गर्नुहोस्" id="filter">खोजी गर्नुहोस्</button>
                   ...
                   <a href="<?php echo base_url()?>NagadiRasid/viewCancelBills" class="btn btn-warning">रद्ध गरिएको रसिदको हेर्नुहोस</a>
    ...
    function fetch_all_data(name, bill_no, from_date, status){
      ...
      var oTable = $('#nagadilist').DataTable({
        ...
        "columns": [
              ...
              {
                "data": "", render: function ( data, type, row ) {
                  var res = '<a class="btn btn-warning"  href="<?php echo base_url()?>NagadiRasid/generateBill/'+row.guid+'">'+'रशिद हेर्नुहोस'+'</a>';
                        res += '</div"></div>';
                  return res;
                },"bVisible": true, "bSearchable": false, "bSortable": false
              },
...

               {
                ...
                "data": "", render: function ( data, type, row ) {
                    ...
                    if(row.cancancel == 1) {
                        ...
                        var res = '<p class="label label-danger">कार्य उपलब्ध छैन</p>';
