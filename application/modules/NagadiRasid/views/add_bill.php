              ...
              <div class="card-body">
                 <?php $success_message = $this->session->flashdata("MSG_ERR");
                      ...
                      <div class="alert alert-success">
                          ...
                          <span> <?php echo $this->session->flashdata("MSG_ERR")?> </span>
                      </div>
                    <?php } ?>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-2">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" placeholder="" name="pan_no"  value="">
                                    </div>
                                  </div>
                                </div>
                              </td>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="rate_type">दर/रकम</label>
                                       <input type="text" name="rate[]" value="" class="form-control topic_fixed_rate" readonly="readonly" style="height: 30px;">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label class="qty_title">परिमाण/रकम  </label>
                                       <input type="text" class="form-control topic_qty" placeholder="" name="qty[]"  value="" style="height: 30px;" autocomplete="off">
 ...
 -->
                                  <div class="col-md-2">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control topic_rate " placeholder="" name="rates[]"  value="" style="height: 30px;">
                                    </div>
                                  </div>
