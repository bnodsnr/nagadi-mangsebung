...
<!-- Mirrored from thevectorlab.net/flatlab-4/email_template.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2019 19:11:37 GMT -->
...
<tbody>
    <tr>
        <td height="40">
            <div>
                <img src="<?php echo base_url()?>assets/img/nepal-govt.png" style="height: 70px; width: 70px; margin-top: 30px;margin-left: 20px;">
                <div style="margin-left:438px;margin-top: -50px">सदिक को फारम नं.११</div>
                <div style="margin-left: 438px; margin-top: -50px">म.ले.प. फारम नं.९०१</div>
                <img src="<?php echo base_url()?>assets/img/nepal-govt.png" style="height: 70px; width: 70px;margin-top: 29px; margin-left:438px;">
            </div>
        </td>
    </tr>
                                ...
                                <tr>
                                    <td align="center">
                                       <!--  <a href="#" style="display: block;"><img  style="display: block;" src="img/email-img/vector-lab.jpg" alt="logo" width="155"></a> -->
                                        ...
                                        <div style="margin-left: -50px;margin-top: 5px;">.............मन्त्रालय / विभाग / कार्यलय</div>
                                        <div style="margin-top: 20px; margin-left: -100px;">कार्यलय कोड नं.</div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<!-- Mirrored from thevectorlab.net/flatlab-4/email_template.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jun 2019 19:11:46 GMT -->
</html>