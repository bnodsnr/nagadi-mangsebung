            ...
            <section class="card">
              <div class="card-header">
                <div class="mail-option">
                   ...
                   <div class="btn-group hidden-phone">
                      <input type="text" id="from_rate" class="form-control" placeholder="देखि" style="width: 230px;">
                   </div>

                   <div class="btn-group hidden-phone">
                      <input type="text" id="from_rate" class="form-control" placeholder="सम्म"style="width: 230px;">
                   </div>
                   <div class="btn-group hidden-phone">
                         <div class="">
                           <select class="form-control" name="sampati_type" id="type" required="required">
                            <option value=""> चयन गर्नुहोस्</option>
                              <option value="1"> व्यक्तिगत करयोग्य सम्पत्ति तर्फ</option>
                              <option value="2"> उद्योगहरुको करयोग्य सम्पत्ति तफ</option>
                          </select>
                          </div>
                    </div>
                    <div class="btn-group hidden-phone">
                ...
                <table  class="table table-inbox table-bordered table-striped" id="listtable">
                  <thead style="background: #1b5693; color:#fff">
                      <tr>
                        ...
                        <th>आ व</th>
                        <th style="width: 200px;"> सम्पत्ति कर</th>
