...
<body style="--bleeding: 0.5cm;--margin: 1cm;">
  ...
  <div style="margin-left: 720px; margin-top:5px;font-size: 18px;">  आन्तरीक संकेत नं.-<?php echo $this->mylibrary->convertedcit('११३१३/११३१४')?>  </div>
 ...
 <table class="print_table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <?php 
         // $text = echo strlen($str);
          //$newtext = wordwrap($text, 20, "<br />\n");

          //echo $text;        
          echo $this->mylibrary->convertedcit($value['k_number'])?>
    ...
    <div style="width: 100%;margin-left: 790px; margin-top: 11px;">
      <table class="">
        ...
        <tr>
          <td style="font-size: 18px"><b>जरिवाना रकम रु:</b></td><td align="right"> <?php echo !empty($kar_details['fine_amount'])?$this->mylibrary->convertedcit(number_format($kar_details['fine_amount'])):'0.00'?></td>
        </tr>
        <tr>
