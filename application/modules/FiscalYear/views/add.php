...
<form action="<?php echo base_url()?>FiscalYear/save" method="post" class="form save_post">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
  <div class="form-group">
    <div class="col-md-12">
      <div class="form-group">
        <label>आर्थिक वर्ष <span style="color:red">*</span></label>
        <input type="text" class="form-control" placeholder=""  name="year" value="" required="required">
      </div>
      <div class="form-group">
       <label><b>यदि चालू हो भने?</b></label>
        <input class="form-check-input" value = "1" type="checkbox" id="gridCheck1" name="is_current" style="margin-left: 5px;">
      </div>
    </div>
  </div>
