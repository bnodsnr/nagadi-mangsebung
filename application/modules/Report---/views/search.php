          ...
          <header class="card-header" style="background: #1b5693;color:#FFF">
              ...
              <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                 ...
                 <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link  btn btn-warning" id="profile-tab" href="<?php echo base_url()?>Report/MonthlyReport">मासिक रिपोर्ट </a>
                  </li>
                  <li class="nav-item">
                      ...
                      <select class="form-control search_added_ward" id="search_ward_no">
                          ...
                          <?php if(!empty($wards)) :
                            ...
                            foreach ($wards as $key => $ward) : ?>
                              ...
                              <option value="<?php if($ward['ward'] == 0){ echo 'nagarpalika';} else {echo $ward['ward'];}?>"><?php 
