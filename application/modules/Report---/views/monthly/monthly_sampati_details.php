        ...
        <section class="card">
          ...
          <div class="card-body">
            ...
            <div class="tab-content tasi-tab" id="">
              ...
              <div class="alert alert-info"><h3 class=""> महिना :<?php 
              $month = getNepaliMonthName($date);
              echo !empty($date)?$month:'';?> सपम्पति-भुमि कर विवरण

              </h3>

              <a href="<?php echo base_url()?>Report/MonthlyReport/printSampatiKarDetails/<?php echo $date.'/'.$ward_no?>" class="btn btn-info">प्रिन्ट गर्नुहोस</a>
                  ...
                  if(!empty($sampati_bhumi_kar)) :
                    ...
                    foreach ($sampati_bhumi_kar as $key => $sampatikar) : ?>
                      ...
                      <tr style="background-color:<?php if($sampatikar['status'] == 2 ){echo 'red';}?>">
                        ...
                        <td><a href="<?php echo base_url()?>SampatiKarRasid/viewRasid/<?php echo $sampatikar['bill_no']?>" class="badge badge-warning" target ="_blank"><i class="fa fa-eye"> </i> <?php echo $this->mylibrary->convertedcit($sampatikar['bill_no'])?></a></td>
