...
<body style="--bleeding: 0.5cm;--margin: 1cm;">
  ...
  <div class="page">
    ...
    <?php 
      if(empty($ward_no)) {
        echo $title['topic_name'].' मासिक सङ्कलन रिपोर्ट';
        } else {
         if($ward_no == '0') {
        echo 'नगर कार्यपालिकाको कार्यालय '.$title['topic_name'].' मासिक  सङ्कलन रिपोर्ट';
        } else {
        echo $this->mylibrary->convertedcit($ward_no) .' नं. वडा कार्यलय '.$title['topic_name'] .'  मासिक सङ्कलन रिपोर्ट';
        }
      }
    ?>
</b></div>
 ...
 <?php if(!empty($nagadi_details)) { ?>
              ...
              <table class="print_table table table-stripe table-bordered">
               ...
               <table class="print_table table table-bordered" style="margin-top:-25px;">
                  <tr>
                    <td colspan="10" style="text-align: right">जम्मा रकम </td>
                    <td colspan="3"><?php echo !empty($total)? $this->mylibrary->convertedcit(round($total)):$this->mylibrary->convertedcit(0)?></td>

                  </tr>

                  <tr>

                    <td colspan="10" style="text-align: right">बदर भएको रसिदको जम्मा रकम  </td>
                  ...
                  <tr>
                    ...
                    <?php 
                      ...
                      echo $this->mylibrary->convertedcit(round($net_total));
