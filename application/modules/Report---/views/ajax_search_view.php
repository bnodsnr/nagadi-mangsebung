  ...
  <div class="alert alert-info"><h3 class="text-center"> नगदी रसिद </h3>
   ...
   <a href="<?php echo base_url()?>Report/Search/printSearch/<?php echo $from_date?>/<?php echo $to_date?>/<?php echo $ward_no?>/<?php echo $user_id?>" class="btn btn-info btn-sm" style="margin-right: 4px;" target="_blank"><i class="fa fa-print" ></i> प्रिन्ट गर्नुहोस</a>
