                ...
                <tbody>
                  ...
                  foreach($details as $key => $detail) : ?>
                    ...
                    <tr style="background-color:<?php if($detail['status'] == 2 ){echo 'red';}else { echo 'green'; }?>;color:#FFF">
                      ...
                      <td><a href="<?php echo base_url()?>NagadiRasid/generateBill/<?php echo $detail['billid']?>" class="badge badge-warning" target ="_blank"><i class="fa fa-eye"> </i><?php echo $this->mylibrary->convertedcit($detail['bill_no'])?></a></td>
