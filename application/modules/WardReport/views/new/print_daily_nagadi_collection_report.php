    ...
    <tbody>
      ...
      <tfoot>
        <tr>
          ...
          ?>
          <td colspan="2" align="left"><?php echo !empty($total)?$this->mylibrary->convertedcit($net_total):$this->mylibrary->convertedcit(0)?> (<?php  echo $this->convertlib->convert($net_total,"मात्र |");?>)</td>
        </tr>
      </tfoot>
    </table>
