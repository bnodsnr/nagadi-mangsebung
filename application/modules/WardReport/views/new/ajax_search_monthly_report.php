 <a href="<?php echo base_url()?>WardReport/viewDailyCollectionDetails/<?php echo $ward_no?>/<?php echo $month?>" class="btn btn-warning btn-sm pull-right"><i class="fa fa-eye"></i> पुरा विवरण हेर्नुहोस</a>
 <a href="<?php echo base_url()?>WardReport/printMonthlyCollection/<?php echo $ward_no.'/'.$month?>" class="btn btn-info btn-sm pull-right" style="margin-right: 4px;"><i class="fa fa-print"></i> प्रिन्ट गर्नुहोस</a>
      ...
      <?php if(!empty($main_topic)) : 
        ...
        foreach($main_topic as $mt):
          ...
          <tr>
            ...
            <?php
            $collection_rate = $this->WardReportModel->SearchMonthltNagadi($mt['id']);
            //pp($collection_rate);
            ?>
            ...
            <td><a href="<?php echo base_url()?>WardReport/viewMonthlyDetailsByTopic/<?php echo $mt['id'].'/'.$month.'/'.$ward_no?>" class="btn btn-warning">विवरण हेर्नुहोस</a></td>
          </tr>
        ...
        <td><a href="<?php echo base_url()?>WardReport/viewSampatiKarDetails/<?php echo $month.'/'.$ward_no?>" class="btn btn-warning">विवरण हेर्नुहोस</a></td>
      </tbody>
      <tfoot>
        <tr>
