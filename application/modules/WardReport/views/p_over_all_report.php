...
<html lang="en">
	...
	<body>
		<div id="container" style="margin:10px;">
			...
			<div style="height: 70px; width: 200px;margin-top: -90px;margin-left:576px;">विदुर नगरपालिका</div>
			<div style="height: 70px; width: 200px;margin-top: -47px;margin-left:550px;"><b>नगर कार्यपालिकाको कार्यालय</b></div>
			<div style="height: 70px; width: 200px;margin-top: -50px;margin-left:580px;"><?php echo NAPA?>
              ...
              <tbody>
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <td colspan="14" style="border: 1px solid #000 !important;border-collapse: collapse;">अक्षरुपी : <?php echo $this->convertlib->convert_number($total_value,"मात्र |")."मात्र |";?></td>
                  </tr>
                </tfoot>
                          </table>
	        </div>
